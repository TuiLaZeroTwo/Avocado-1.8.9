 ...
 */
package net.ccbluex.avocado.features.command

import net.ccbluex.avocado.features.command.commands.*
import net.ccbluex.avocado.features.command.shortcuts.Shortcut
import net.ccbluex.avocado.features.command.shortcuts.ShortcutParser
import net.ccbluex.avocado.features.command.special.*
import net.ccbluex.avocado.file.FileManager.saveConfig
import net.ccbluex.avocado.file.FileManager.shortcutsConfig
