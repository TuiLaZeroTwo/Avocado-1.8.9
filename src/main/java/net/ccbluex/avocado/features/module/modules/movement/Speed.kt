...
import net.ccbluex.avocado.features.module.modules.movement.speedmodes.aac.AACHop3313
import net.ccbluex.avocado.features.module.modules.movement.speedmodes.aac.AACHop350
import net.ccbluex.avocado.features.module.modules.movement.speedmodes.aac.AACHop4
import net.ccbluex.avocado.features.module.modules.movement.speedmodes.aac.AACHop5
import net.ccbluex.avocado.features.module.modules.movement.speedmodes.hypixel.HypixelHop
import net.ccbluex.avocado.features.module.modules.movement.speedmodes.hypixel.HypixelLowHop
import net.ccbluex.avocado.features.module.modules.movement.speedmodes.intave.IntaveHop14
import net.ccbluex.avocado.features.module.modules.movement.speedmodes.matrix.MatrixHop
import net.ccbluex.avocado.features.module.modules.movement.speedmodes.matrix.MatrixSlowHop
import net.ccbluex.avocado.features.module.modules.movement.speedmodes.matrix.OldMatrixHop
import net.ccbluex.avocado.features.module.modules.movement.speedmodes.ncp.*
import net.ccbluex.avocado.features.module.modules.movement.speedmodes.other.*
import net.ccbluex.avocado.features.module.modules.movement.speedmodes.spartan.SpartanYPort
import net.ccbluex.avocado.features.module.modules.movement.speedmodes.spectre.SpectreBHop
import net.ccbluex.avocado.features.module.modules.movement.speedmodes.spectre.SpectreLowHop
import net.ccbluex.avocado.features.module.modules.movement.speedmodes.spectre.SpectreOnGround
import net.ccbluex.avocado.features.module.modules.movement.speedmodes.verus.VerusFHop
import net.ccbluex.avocado.features.module.modules.movement.speedmodes.verus.VerusHop
import net.ccbluex.avocado.features.module.modules.movement.speedmodes.verus.VerusLowHop
import net.ccbluex.avocado.features.module.modules.movement.speedmodes.verus.VerusLowHopNew
import net.ccbluex.avocado.features.module.modules.movement.speedmodes.vulcan.VulcanGround288
import net.ccbluex.avocado.features.module.modules.movement.speedmodes.vulcan.VulcanHop
import net.ccbluex.avocado.features.module.modules.movement.speedmodes.vulcan.VulcanLowHop
