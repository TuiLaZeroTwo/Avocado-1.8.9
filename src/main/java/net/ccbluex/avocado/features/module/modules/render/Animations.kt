...
object Animations : Module("Animations", Category.RENDER, gameDetecting = false) {
    ...
    val xinxinRotationSpeed by float("XinXin-RotationSpeed", 2.0f, 0.1f..10.0f) { animationMode == "XinXin" }
    val xinxinScale by float("XinXin-Scale", 1.0f, 0.1f..2.0f) { animationMode == "XinXin" }
...
class XinXinAnimation : Animation("XinXin") {
    private var rotationAngle = 0f
    private val rotationTimer = MSTimer()
