...
import net.ccbluex.avocado.config.ListValue
import net.ccbluex.avocado.features.module.Category
import net.ccbluex.avocado.features.module.Module
import net.ccbluex.avocado.features.module.modules.combat.AutoArmor
import net.ccbluex.avocado.utils.block.BlockUtils.isFullBlock
import net.ccbluex.avocado.utils.client.chat
import net.ccbluex.avocado.utils.extensions.shuffled
import net.ccbluex.avocado.utils.inventory.*
import net.ccbluex.avocado.utils.inventory.ArmorComparator.getBestArmorSet
import net.ccbluex.avocado.utils.inventory.InventoryManager.canClickInventory
import net.ccbluex.avocado.utils.inventory.InventoryManager.hasScheduledInLastLoop
import net.ccbluex.avocado.utils.inventory.InventoryManager.invCleanerCurrentSlot
import net.ccbluex.avocado.utils.inventory.InventoryManager.invCleanerLastSlot
import net.ccbluex.avocado.utils.inventory.InventoryManager.passedPostInventoryCloseDelay
import net.ccbluex.avocado.utils.inventory.InventoryUtils.isFirstInventoryClick
import net.ccbluex.avocado.utils.inventory.InventoryUtils.serverOpenInventory
import net.ccbluex.avocado.utils.inventory.InventoryUtils.toHotbarIndex
import net.ccbluex.avocado.utils.timing.TickedActions.awaitTicked
import net.ccbluex.avocado.utils.timing.TickedActions.clickNextTick
import net.ccbluex.avocado.utils.timing.TickedActions.isTicked
