...
import net.ccbluex.avocado.features.module.modules.movement.flymodes.aac.*
import net.ccbluex.avocado.features.module.modules.movement.flymodes.blocksmc.BlocksMC
import net.ccbluex.avocado.features.module.modules.movement.flymodes.blocksmc.BlocksMC2
import net.ccbluex.avocado.features.module.modules.movement.flymodes.hypixel.BoostHypixel
import net.ccbluex.avocado.features.module.modules.movement.flymodes.hypixel.FreeHypixel
import net.ccbluex.avocado.features.module.modules.movement.flymodes.hypixel.Hypixel
import net.ccbluex.avocado.features.module.modules.movement.flymodes.ncp.NCP
import net.ccbluex.avocado.features.module.modules.movement.flymodes.ncp.OldNCP
import net.ccbluex.avocado.features.module.modules.movement.flymodes.other.*
import net.ccbluex.avocado.features.module.modules.movement.flymodes.spartan.BugSpartan
import net.ccbluex.avocado.features.module.modules.movement.flymodes.spartan.Spartan
import net.ccbluex.avocado.features.module.modules.movement.flymodes.spartan.Spartan2
import net.ccbluex.avocado.features.module.modules.movement.flymodes.vanilla.SmoothVanilla
import net.ccbluex.avocado.features.module.modules.movement.flymodes.vanilla.Vanilla
import net.ccbluex.avocado.features.module.modules.movement.flymodes.verus.Verus
import net.ccbluex.avocado.features.module.modules.movement.flymodes.verus.VerusGlide
import net.ccbluex.avocado.features.module.modules.movement.flymodes.vulcan.Vulcan
import net.ccbluex.avocado.features.module.modules.movement.flymodes.vulcan.VulcanGhost
import net.ccbluex.avocado.features.module.modules.movement.flymodes.vulcan.VulcanOld
import net.ccbluex.avocado.utils.client.PacketUtils.sendPacket
import net.ccbluex.avocado.utils.extensions.stop
import net.ccbluex.avocado.utils.extensions.stopXZ
import net.ccbluex.avocado.utils.render.RenderUtils.drawPlatform
