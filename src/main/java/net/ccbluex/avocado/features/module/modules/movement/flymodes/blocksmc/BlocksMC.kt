 ...
 */
package net.ccbluex.avocado.features.module.modules.movement.flymodes.blocksmc
...
import net.ccbluex.avocado.features.module.modules.movement.Fly.boostSpeed
import net.ccbluex.avocado.features.module.modules.movement.Fly.debugFly
import net.ccbluex.avocado.features.module.modules.movement.Fly.extraBoost
import net.ccbluex.avocado.features.module.modules.movement.Fly.stable
import net.ccbluex.avocado.features.module.modules.movement.Fly.stopOnLanding
import net.ccbluex.avocado.features.module.modules.movement.Fly.stopOnNoMove
import net.ccbluex.avocado.features.module.modules.movement.Fly.timerSlowed
 ...
 * https://github.com/shxp3/CrossSine/blob/main/src/main/java/net/ccbluex/avocado/features/module/modules/movement/flights/ncp/LatestNCP.java
 *
 * Modified by @Eclipses and mixed with code from NextGen:
 * https://github.com/CCBlueX/Avocado/blob/nextgen/src/main/kotlin/net/ccbluex/avocado/features/module/modules/movement/fly/modes/specific/FlyNcpClip.kt
 *
