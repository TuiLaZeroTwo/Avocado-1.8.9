...
import net.ccbluex.avocado.features.module.modules.movement.longjumpmodes.aac.AACv1
import net.ccbluex.avocado.features.module.modules.movement.longjumpmodes.aac.AACv2
import net.ccbluex.avocado.features.module.modules.movement.longjumpmodes.aac.AACv3
import net.ccbluex.avocado.features.module.modules.movement.longjumpmodes.ncp.NCP
import net.ccbluex.avocado.features.module.modules.movement.longjumpmodes.other.Buzz
import net.ccbluex.avocado.features.module.modules.movement.longjumpmodes.other.Hycraft
import net.ccbluex.avocado.features.module.modules.movement.longjumpmodes.other.Redesky
import net.ccbluex.avocado.features.module.modules.movement.longjumpmodes.other.VerusDamage
import net.ccbluex.avocado.features.module.modules.movement.longjumpmodes.other.VerusDamage.damaged
