...
import net.ccbluex.avocado.features.module.modules.combat.Backtrack.runWithSimulatedPosition
import net.ccbluex.avocado.features.module.modules.player.Blink
import net.ccbluex.avocado.features.module.modules.world.Fucker
import net.ccbluex.avocado.features.module.modules.world.Nuker
import net.ccbluex.avocado.features.module.modules.world.scaffolds.*
import net.ccbluex.avocado.utils.attack.CPSCounter
import net.ccbluex.avocado.utils.attack.CooldownHelper.getAttackCooldownProgress
import net.ccbluex.avocado.utils.attack.CooldownHelper.resetLastAttackedTicks
...
import net.ccbluex.avocado.utils.client.ClientUtils.runTimeTicks
...
import net.ccbluex.avocado.utils.render.RenderUtils.drawCircle
import net.ccbluex.avocado.utils.render.RenderUtils.drawEntityBox
import net.ccbluex.avocado.utils.render.RenderUtils.drawPlatform
import net.ccbluex.avocado.utils.rotation.RandomizationSettings
import net.ccbluex.avocado.utils.rotation.RaycastUtils.raycastEntity
import net.ccbluex.avocado.utils.rotation.RaycastUtils.runWithModifiedRaycastResult
...
import net.ccbluex.avocado.utils.rotation.RotationUtils.isRotationFaced
import net.ccbluex.avocado.utils.rotation.RotationUtils.isVisible
import net.ccbluex.avocado.utils.rotation.RotationUtils.rotationDifference
import net.ccbluex.avocado.utils.rotation.RotationUtils.searchCenter
...
import net.ccbluex.avocado.utils.timing.TimeUtils.randomClickDelay
            ...
            if (swing && failSwing) {
                ...
                runWithModifiedRaycastResult(rotation, range.toDouble(), throughWallsRange.toDouble()) {
                    ...
                    val isAnyClientGuiActive = mc.currentScreen?.javaClass?.`package`?.name?.contains(
                        Avocado.CLIENT_NAME, ignoreCase = true
                    ) == true
