...
import net.ccbluex.avocado.features.module.modules.combat.AutoClicker;
import net.ccbluex.avocado.features.module.modules.combat.TickBase;
import net.ccbluex.avocado.features.module.modules.exploit.AbortBreaking;
import net.ccbluex.avocado.features.module.modules.exploit.MultiActions;
import net.ccbluex.avocado.features.module.modules.world.FastPlace;
import net.ccbluex.avocado.file.configs.models.ClientConfiguration;
import net.ccbluex.avocado.injection.forge.SplashProgressLock;
...
public abstract class MixinMinecraft {
    ...
    private void createDisplay(CallbackInfo callbackInfo) {
        if (ClientConfiguration.INSTANCE.getClientTitle()) {
            Display.setTitle(Avocado.INSTANCE.getClientTitle());
        }
    }

    @Inject(method = "displayGuiScreen",
            at = @At(value = "FIELD",
