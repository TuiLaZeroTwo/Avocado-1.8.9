 ...
 */
package net.ccbluex.avocado.api

import net.ccbluex.avocado.Avocado
import net.ccbluex.avocado.Avocado.IN_DEV
import net.ccbluex.avocado.Avocado.clientVersionNumber
...
object ClientUpdate {
    ...
    val gitInfo = Properties().also {
        val inputStream = Avocado::class.java.classLoader.getResourceAsStream("git.properties")

        if (inputStream != null) {
            it.load(inputStream)
        } else {
            it["git.build.version"] = "B1.3"
        }
    }
