 ...
 */
package net.ccbluex.avocado.ui.client.clickgui

import kotlinx.coroutines.launch
import net.ccbluex.avocado.Avocado.CLIENT_NAME
import net.ccbluex.avocado.Avocado.moduleManager
import net.ccbluex.avocado.api.ClientApi
import net.ccbluex.avocado.api.autoSettingsList
import net.ccbluex.avocado.api.loadSettings
import net.ccbluex.avocado.config.SettingsUtils
import net.ccbluex.avocado.features.module.Category
import net.ccbluex.avocado.features.module.modules.render.ClickGUI
...
import net.ccbluex.avocado.features.module.modules.render.ClickGUI.scrolls
...
import net.ccbluex.avocado.utils.client.asResourceLocation
import net.ccbluex.avocado.utils.client.chat
import net.ccbluex.avocado.utils.client.playSound
