...
import net.ccbluex.avocado.ui.client.hud.HUD.notifications
...
import net.ccbluex.avocado.ui.client.hud.element.elements.Notification.Companion.maxTextLength
...
class Notifications(
    ...
    enum class SeverityType(val path: ResourceLocation) {
        SUCCESS(ResourceLocation("avocado/notifications/success.png")), RED_SUCCESS(ResourceLocation("avocado/notifications/redsuccess.png")), INFO(
            ResourceLocation("avocado/notifications/info.png")
        ),
        WARNING(ResourceLocation("avocado/notifications/warning.png")), ERROR(ResourceLocation("avocado/notifications/error.png"))
    }
}
