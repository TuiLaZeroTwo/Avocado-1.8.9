 ...
 */
package net.ccbluex.avocado.ui.client.clickgui.style

import net.ccbluex.avocado.config.ColorValue
import net.ccbluex.avocado.config.Value
...
import net.ccbluex.avocado.utils.extensions.decimalPlaces
