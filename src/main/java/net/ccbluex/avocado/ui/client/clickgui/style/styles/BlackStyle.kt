 ...
 */
package net.ccbluex.avocado.ui.client.clickgui.style.styles

import net.ccbluex.avocado.config.*
import net.ccbluex.avocado.features.module.modules.render.ClickGUI.scale
import net.ccbluex.avocado.ui.client.clickgui.ClickGui.clamp
import net.ccbluex.avocado.ui.client.clickgui.Panel
import net.ccbluex.avocado.ui.client.clickgui.elements.ButtonElement
import net.ccbluex.avocado.ui.client.clickgui.elements.ModuleElement
import net.ccbluex.avocado.ui.client.clickgui.style.Style
import net.ccbluex.avocado.ui.font.AWTFontRenderer.Companion.assumeNonVolatile
import net.ccbluex.avocado.ui.font.Fonts.fontSemibold35
import net.ccbluex.avocado.utils.block.BlockUtils.getBlockName
import net.ccbluex.avocado.utils.extensions.component1
import net.ccbluex.avocado.utils.extensions.component2
import net.ccbluex.avocado.utils.extensions.lerpWith
import net.ccbluex.avocado.utils.render.ColorUtils
import net.ccbluex.avocado.utils.render.ColorUtils.blendColors
import net.ccbluex.avocado.utils.render.ColorUtils.withAlpha
import net.ccbluex.avocado.utils.render.RenderUtils
import net.ccbluex.avocado.utils.render.RenderUtils.drawBorderedRect
import net.ccbluex.avocado.utils.render.RenderUtils.drawFilledCircle
import net.ccbluex.avocado.utils.render.RenderUtils.drawRect
import net.ccbluex.avocado.utils.render.RenderUtils.drawTexture
import net.ccbluex.avocado.utils.render.RenderUtils.updateTextureCache
import net.ccbluex.avocado.utils.ui.EditableText
