 ...
 */
package net.ccbluex.avocado.ui.client.hud.designer

import net.ccbluex.avocado.config.*
import net.ccbluex.avocado.features.module.modules.render.ClickGUI.guiColor
...
import net.ccbluex.avocado.ui.client.hud.HUD.ELEMENTS
import net.ccbluex.avocado.ui.client.hud.element.Element
import net.ccbluex.avocado.ui.client.hud.element.Side
...
import net.ccbluex.avocado.utils.render.ColorUtils.minecraftRed
...
import net.ccbluex.avocado.utils.render.RenderUtils.makeScissorBox
...
import net.ccbluex.avocado.ui.client.clickgui.style.styles.BlackStyle.rgbaLabels
