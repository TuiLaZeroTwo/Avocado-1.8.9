...
import net.ccbluex.avocado.Avocado.CLIENT_AUTHOR
import net.ccbluex.avocado.Avocado.CLIENT_NAME
import net.ccbluex.avocado.Avocado.clientCommit
import net.ccbluex.avocado.Avocado.clientVersionText
import net.ccbluex.avocado.features.module.modules.combat.KillAura.blockStatus
...
import net.ccbluex.avocado.ui.client.hud.element.Border
import net.ccbluex.avocado.ui.client.hud.element.Element
import net.ccbluex.avocado.ui.client.hud.element.ElementInfo
...
import net.ccbluex.avocado.ui.font.GameFontRenderer
import net.ccbluex.avocado.utils.attack.CPSCounter
import net.ccbluex.avocado.utils.client.PPSCounter
...
import net.ccbluex.avocado.utils.render.shader.shaders.GradientFontShader
import net.ccbluex.avocado.utils.render.shader.shaders.GradientShader
...
class Text(x: Double = 10.0, y: Double = 10.0, scale: Float = 1F, side: Side = Side.default()) : Element(
    ...
    companion object {
        ...
        fun defaultClientVersion(): Text {
            val text = Text(x = 94.0, y = 25.0, scale = 1F)
