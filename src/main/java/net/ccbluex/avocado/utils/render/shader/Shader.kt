 ...
 */
package net.ccbluex.avocado.utils.render.shader
...
abstract class Shader : MinecraftInstance {
    ...
    constructor(fragmentShader: String) {
        ...
        try {
            val vertexStream = javaClass.getResourceAsStream("/assets/minecraft/avocado/shader/vertex.vert")
            vertexShaderID = createShader(IOUtils.toString(vertexStream), ARBVertexShader.GL_VERTEX_SHADER_ARB)
            IOUtils.closeQuietly(vertexStream)
            
            val fragmentStream = javaClass.getResourceAsStream("/assets/minecraft/avocado/shader/fragment/$fragmentShader")
