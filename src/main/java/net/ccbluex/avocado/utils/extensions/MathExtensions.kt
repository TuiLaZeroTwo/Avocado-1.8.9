...
import net.ccbluex.avocado.config.FloatRangeValue
import net.ccbluex.avocado.config.FloatValue
import net.ccbluex.avocado.config.IntRangeValue
import net.ccbluex.avocado.config.IntValue
