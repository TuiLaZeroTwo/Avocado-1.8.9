 ...
 */
package net.ccbluex.avocado.utils.attack

import net.ccbluex.avocado.config.Configurable
import net.ccbluex.avocado.features.module.modules.combat.NoFriends
import net.ccbluex.avocado.features.module.modules.misc.AntiBot.isBot
import net.ccbluex.avocado.features.module.modules.misc.Teams
import net.ccbluex.avocado.ui.font.GameFontRenderer.Companion.getColorIndex
import net.ccbluex.avocado.utils.client.MinecraftInstance
import net.ccbluex.avocado.utils.extensions.isAnimal
import net.ccbluex.avocado.utils.extensions.isClientFriend
import net.ccbluex.avocado.utils.extensions.isMob
import net.ccbluex.avocado.utils.extensions.toRadiansD
import net.ccbluex.avocado.utils.kotlin.StringUtils.contains
