 ...
 */
package net.ccbluex.avocado.utils.io
...
/**
 * User agent
 * Avocado/<version> (<commit>, <branch>, <build-type>, <platform>)
 */
val DEFAULT_AGENT =
    "${Avocado.CLIENT_NAME}/${Avocado.clientVersionText} (${Avocado.clientCommit}, ${Avocado.clientBranch}, ${if (Avocado.IN_DEV) "dev" else "release"}, ${System.getProperty("os.name")})"
