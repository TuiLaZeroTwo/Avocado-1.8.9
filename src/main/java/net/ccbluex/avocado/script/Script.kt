 ...
 */
package net.ccbluex.avocado.script
...
import net.ccbluex.avocado.Avocado.scriptManager
...
import net.ccbluex.avocado.script.ScriptManager.scriptsFolder
import net.ccbluex.avocado.script.api.ScriptCommand
import net.ccbluex.avocado.script.api.ScriptModule
import net.ccbluex.avocado.script.api.ScriptTab
import net.ccbluex.avocado.script.api.global.Chat
import net.ccbluex.avocado.script.api.global.Item
import net.ccbluex.avocado.script.api.global.Setting
